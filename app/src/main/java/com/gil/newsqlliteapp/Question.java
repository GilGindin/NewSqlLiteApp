...
public class Question implements Parcelable {
    ...
    public Question(String question, String option1, String option2, String option3, int answerNr , String difficult , int categoryId) {
    ...
    public static String[] getAllDifficultLvl(){
        return new String[]{
                DIFFICULT_EASY , DIFFICULT_MEDIUM , DIFFICULT_HARD
        };
    }
}
